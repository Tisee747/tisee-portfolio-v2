    ...
    <main className="relative min-h-screen overflow-x-hidden bg-white px-6 pb-24 pt-28 selection:bg-blue-100 selection:text-blue-900 sm:pt-32 md:px-12">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col">
        <FadeIn className="flex flex-col gap-8 border-b border-zinc-100 pb-12 sm:pb-16 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-wrap gap-2 md:hidden" role="group" aria-label="Filter projects">
            {FILTERS.map((filter) => (
              <button
                key={filter}
                type="button"
          ...
          <div ref={filterMenuRef} className="relative hidden md:flex md:justify-end">
            <button
              ...
              className="inline-flex min-h-11 items-center gap-2.5 rounded-md px-1 text-sm font-medium text-zinc-950 transition-opacity duration-200 hover:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-4"
            >
              <FilterIcon />
            ...
            {isFilterOpen && (
              <div
                ...
                className="absolute right-0 top-[calc(100%+0.625rem)] z-30 w-48 rounded-2xl border border-zinc-200 bg-white p-1.5 shadow-[0_18px_48px_rgba(24,24,27,0.13)]"
              >
                {FILTERS.map((filter) => {
