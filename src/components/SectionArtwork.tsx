...
export default function SectionArtwork({ variant, className = "" }: SectionArtworkProps) {
  const artworkClassName = `tisee-section-artwork tisee-section-artwork-${variant} pointer-events-none absolute inset-0 overflow-hidden ${className}`;

  if (variant === "experience") {
    return (
      <div className={artworkClassName} aria-hidden="true">
        <div className="tisee-section-artwork-motion">
