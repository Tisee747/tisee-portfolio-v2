      ...
      <nav className="w-full bg-white">
        <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-0.5 sm:gap-2">
            ...
            <Link
              href="/#contact"
              className="group relative ml-1 inline-flex min-h-11 items-center justify-center overflow-hidden rounded-[14px] border border-zinc-950 bg-white px-4 text-xs font-semibold tracking-[0.045em] text-zinc-950 shadow-[0_4px_0_#18181b,0_10px_24px_rgba(9,9,11,0.10)] transition-[transform,background-color,color,box-shadow] duration-200 ease-out before:pointer-events-none before:absolute before:inset-[3px] before:rounded-[10px] before:border before:border-zinc-200 before:content-[''] hover:-translate-y-px hover:bg-zinc-950 hover:text-white hover:shadow-[0_2px_0_#18181b,0_12px_28px_rgba(9,9,11,0.16)] active:translate-y-[2px] active:shadow-[0_1px_0_#18181b,0_6px_14px_rgba(9,9,11,0.10)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-3 motion-reduce:transform-none sm:px-5 sm:text-[13px]"
            >
